      ...
      if ($request->type == 1) {    //create and update LegisCompro
        ...
        if ($dataCompro == NULL) {
          $LegisCompro = new Legiscompromise([
            ...
            'Sum_Promise' => str_replace(",","",$request->CompoundTotal_1),
            'TotalSum_Promise' => str_replace(",","",$request->TotalPrice),
            'TotalPaid_Promise' => str_replace(",","",$request->TotalPaid),
            'Compen_Promise' => str_replace(",","",$request->Compensation) ,
            'P_Compen_Promise' => str_replace(",","",$request->PercentCompensation),
            'TotalCapital_Promise' => str_replace(",","",$request->TotalCapital),
            'FeePrire_Promise' => str_replace(",","",$request->FeePrire),
            'P_FeePrire_Promise' => str_replace(",","",$request->PercentFeePrire),
            'TotalCost_Promise' => str_replace(",","",$request->TotalCost),
            'Payall_Promise' => str_replace(",","",$request->firstMoney),
            'P_Payall_Promise' => str_replace(",","",$request->PercentfirstMoney),
            'Total_Promise' => str_replace(",","",$request->SHowTotal),
            'DuePay_Promise' => str_replace(",","",$request->Installment),
            'P_DuePay_Promise' => str_replace(",","",$request->PercentInstallment),
            'ShowDue_Promise' => str_replace(",","",$request->ShowDue),
            'ShowPeriod_Promise' => str_replace(",","",$request->ShowPeriod),
            'CompoundTotal_1' => str_replace(",","",$request->CompoundTotal_1),
            'FirstManey_1' => str_replace(",","",$request->First_1),
            'Due_1' => str_replace(",","",$request->Due_1),
            'Period_1' => str_replace(",","",$request->Period_1),
            'Profit_1' => str_replace(",","",$request->Profit_1),
            'PercentProfit_1' => str_replace(",","",$request->PercentProfit_1),
