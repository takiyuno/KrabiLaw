...
class Legiscourt extends Model
{
  ...
  protected $fillable = ['legislation_id','fillingdate_court','law_court','bnumber_court','rnumber_court','capital_court','indictment_court','pricelawyer_court','SueNote_court',
