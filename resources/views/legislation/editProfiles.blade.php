              ...
              <div class="card-body text-sm">
                <h6 class="m-b-20 p-b-5 b-b-default f-w-600 SubHeading SizeText">ทั่วไป <span class="textHeader">(Generals)</span></h6>
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group row mb-0">
                        <label class="col-sm-4 col-form-label text-right SizeText text-red">ราคาตั้งขาย:</label>
                        <div class="col-sm-8">
                          <input type="text" name="SaleLandPrice" value="{{ @$data->SaleLandPrice }}" class="form-control form-control-sm SizeText" {{@$data->SaleLandPrice>0?'readonly':''}}/>
                        </div>
                      </div>
                    </div>
                    @endif
